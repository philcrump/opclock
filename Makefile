...
all: _print_banner opclock opclock-waittimesync opclock-waitnetwork

opclock: ${OBJS} $(SRCDIR)/main.o
	@echo "  LD     "$@
	@${CC} ${COPT} ${CFLAGS} -o $@ ${OBJS} $(SRCDIR)/main.o ${LDFLAGS}

opclock-waitnetwork: ${OBJS} $(SRCDIR)/main-waitnetwork.o
	@echo "  LD     "$@
	@${CC} ${COPT} ${CFLAGS} -o $@ ${OBJS} $(SRCDIR)/main-waitnetwork.o ${LDFLAGS}

opclock-waittimesync: ${OBJS} $(SRCDIR)/main-waittimesync.o
	@echo "  LD     "$@
	@${CC} ${COPT} ${CFLAGS} -o $@ ${OBJS} $(SRCDIR)/main-waittimesync.o ${LDFLAGS}
